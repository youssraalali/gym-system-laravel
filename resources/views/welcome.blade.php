...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    ...
    <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
        <div class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div class="text-[13px] leading-[20px] flex-1 p-6 pb-6 lg:p-20 lg:pb-10 bg-[#fffaed] text-[#f53003] shadow-[inset_0px_0px_0px_1px_rgba(245,48,3,0.16)] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                {{ session('error') }}
            </div>
        </div>
    </div>
    @endsession
    <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
        <main class="flex max-w-[335px] w-full flex-col lg:max-w-4xl lg:flex-row gap-6">
            <!-- Hero Secrtion -->
            <div class="flex-1 p-6 lg:p-20 bg-gray-900 text-white shadow-[inset_0px_0px_0px_1px_rgba(255,255,255,0.1)] rounded-lg">
                <div class="mb-6">
                    <span class="text-blue-400 text-xs font-semibold uppercase tracking-wider">Welcome to</span>
                    <h1 class="text-4xl font-bold text-white mt-2 mb-4">GymSystem</h1>
                    <p class="text-gray-400 text-sm leading-7">
                        Manage your membership, track your plan, and stay on top of your fitness journey — all in one place.
                    </p>
                </div>
...
@endif
                ...
                <div class="grid grid-cols-3 gap-4 mt-12 pt-8 border-t border-gray-700">
                    <div>
                        <p class="text-2xl font-bold text-white">100+</p>
                        <p class="text-gray-400 text-xs mt-1">Active Members</p>
                    </div>
                    <div>
                        <p class="text-2xl font-bold text-white">5+</p>
                        <p class="text-gray-400 text-xs mt-1">Membership Plans</p>
                    </div>
                    <div>
                        <p class="text-2xl font-bold text-white">24/7</p>
                        <p class="text-gray-400 text-xs mt-1">Access</p>
                    </div>
                </div>
            </div>
        </main>
