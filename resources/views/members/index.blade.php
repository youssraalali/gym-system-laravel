                ...
                <div class="relative overflow-x-auto">
                    <div class="p-4 flex items-center justify-between space-x-4">
                        <div class="relative">
                            ...
                            <input type="text" class="block w-full max-w-96 ps-9 pe-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 placeholder:text-gray-400" placeholder="Search members">
                        </div>
                        <a href="{{ route('members.create') }}" class="shrink-0 inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm px-4 py-2 rounded-lg">
                            + Add Member
                        </a>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="py-4 sm:space-x-6 flex">
                                    <a href="{{ route('members.show', $member) }}" class="font-medium text-blue-600 dark:text-blue-400 hover:underline">View</a>
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">No members found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
